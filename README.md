...
# task1 - Web Scraping with Python
...
# Task 2 - Storing Data in MongoDB and Building a Flask API

## Objective

This task aims to store the data collected in Week 1 into MongoDB and build a Flask API for accessing and analyzing the data through various endpoints.

## Prerequisites

- Completion of Week 1 (web scraping)
- Basic knowledge of databases and Flask framework

## Setup

1. **Install MongoDB**: Download and install [MongoDB Community Edition](https://www.mongodb.com/try/download/community). Ensure MongoDB is running locally.
2. **Install Python Libraries**: Run `pip install pymongo flask` in your terminal to install the required libraries.

## Task Overview

1. **Store Data in MongoDB**: 
   - Load the scraped JSON data from Week 1.
...
By the end of Week 2, you'll have experience in:
...
### task 3: Data Visualization with amCharts
Objective
Create 30 different visualizations using amCharts to represent insights from the data.
...
Results:
Visualizations: Provide screenshots and descriptions of the visualizations created.


### Task 4 - Advanced Data Analysis and Insights
...
## Prerequisites
- **Week 3 Completion**: Visualizations using amCharts.
...
## Setup
1. **Install NLP Libraries**: Set up TextBlob, spaCy, or NLTK for sentiment and entity extraction.
2. **Prepare MongoDB**: Ensure the database is ready for storing sentiment and entity results.
...
- **Security**: Protect the API with security measures (e.g., authentication, rate limiting).
